...
const Paginator = ({ page, setNext, setPrev, pageCount, total, isLoading }: IProp) => {
  return (
    <div className=" mt-12 space-y-3">
      <div className="flex justify-center items-center w-full ">
        ...
        <button
          type="button"
          className="bg-gray-800 text-white rounded-l-md border-r border border-gray-100 flex items-center justify-center px-7 h-10  text-base font-medium rounded-lg hover:bg-indigo-600 hover:text-white dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white disabled:bg-gray-400 disabled:hover:bg-gray-400 disabled:cursor-not-allowed"
